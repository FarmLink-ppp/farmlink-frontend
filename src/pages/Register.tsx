...
import { Eye, EyeOff, ArrowLeft, Check, Users, Leaf, TrendingUp } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-farmlink-green via-farmlink-mediumgreen to-farmlink-darkgreen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="hidden lg:block space-y-8 text-white">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xl text-farmlink-offwhite/90 leading-relaxed">
                Start your journey towards smarter farming. Connect with experts, get AI-powered insights, and grow your agricultural success.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 mt-12">
            <div className="flex items-center space-x-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                <h3 className="text-white font-semibold text-lg">10,000+ Farmers</h3>
                <p className="text-farmlink-offwhite/80">Join our growing community</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                ...
                <p className="text-farmlink-offwhite/80">Get personalized farming advice</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                <h3 className="text-white font-semibold text-lg">Increase Yields</h3>
                <p className="text-farmlink-offwhite/80">Average 25% productivity boost</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-xl mx-auto lg:mx-0">
          {/* Back Button */}
          <Link to="/welcome" className="inline-flex items-center text-white mb-8 hover:text-farmlink-offwhite transition-colors group">
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-0 overflow-hidden">
            ...
            <CardHeader className="text-center pt-8 pb-6">
              ...
              <CardTitle className="text-3xl text-farmlink-darkgreen mb-2">Join FarmLink</CardTitle>
              <p className="text-farmlink-darkgreen/70 text-lg">Create your account and start smart farming</p>
            </CardHeader>
            ...
            <CardContent className="px-8 pb-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-farmlink-darkgreen font-medium">Email Address</Label>
                  <Input
                    id="email"
                    name="email"
                    type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="password" className="text-farmlink-darkgreen font-medium">Password</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className="text-farmlink-darkgreen font-medium">Confirm Password</Label>
                    <div className="relative">
                      <Input
                        id="confirmPassword"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="farmSize" className="text-farmlink-darkgreen font-medium">Farm Size (acres)</Label>
                    <Input
                      id="farmSize"
                      name="farmSize"
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="location" className="text-farmlink-darkgreen font-medium">Location</Label>
                    <Input
                      id="location"
                      name="location"
                ...
                <div className="flex items-start space-x-3 mt-6">
                  ...
                  <Label className="text-sm text-farmlink-darkgreen/80 leading-relaxed">
                    I agree to the{" "}
                    <Link to="/terms" className="text-farmlink-green hover:text-farmlink-darkgreen transition-colors font-medium">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link to="/privacy" className="text-farmlink-green hover:text-farmlink-darkgreen transition-colors font-medium">
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-farmlink-darkgreen/70">
                  ...
                  <Link to="/login" className="text-farmlink-green hover:text-farmlink-darkgreen transition-colors font-semibold">
                    Sign in here
                  </Link>
                </p>
              </div>
